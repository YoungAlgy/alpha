// Canonical reader-facing copy, single-sourced so it can't drift. The product
// pitch was hand-typed across the hero, the page metadata, the JSON-LD
// description, the sample page, and the share text, and had already drifted
